class Hand():   
    ...
    def _royal_flush(self):
        ...
        if is_straight_flush == False:
            return False
        is_royale_flush = self.cards[-1].rank == "Ace"
        return is_straight_flush and is_royale_flush
    ...
    def _flush(self):
        ...
        return len(suits_that_occur_five_or_more_times) == 1
